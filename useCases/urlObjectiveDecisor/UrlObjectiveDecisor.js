    ...
    getUrlObjective(realState, operation, propertyType) {
        ...
        switch (searchedCase) {
            ...
            case `${RealStates.MercadoLibre.id}-${PropertyType.House}-${Operations.Rent}`:
                ...
                break
            case `${RealStates.ReMax.id}-${PropertyType.House}-${Operations.Rent}`:
                urlObjective = [
                    {
                        id: Cities.Moron,
                        url: "https://api-ar.redremax.com/remaxweb-ar/api/listings/findAllWithEntrepreneurships?page=0&pageSize=24&sort=-createdAt&in=operationId:2&in=eStageId:0,1,2,3,4&in=typeId:9,10,11&locations=in:::88@%3Cb%3EMoron%3C/b%3E::::&landingPath=listings"
                    },
                    {
                        id: Cities.Ituzaingo,
                        url: "https://api-ar.redremax.com/remaxweb-ar/api/listings/findAllWithEntrepreneurships?page=0&pageSize=24&sort=-createdAt&in=operationId:2&in=eStageId:0,1,2,3,4&in=typeId:9,10,11&locations=in:::64@%3Cb%3EItuzaingo%3C/b%3E::::&landingPath=listings"
                    }
                ]
                break
            case `${RealStates.Argenprop.id}-${PropertyType.House}-${Operations.Rent}`:
                urlObjective = [
                    {
                        id: Cities.Moron,
                        url: "https://www.argenprop.com/casas/alquiler/moron?pagina-"
                    },
                    {
                        id: Cities.Ituzaingo,
                        url: "https://www.argenprop.com/casas/alquiler/ituzaingo?pagina-"
                    }
                ]
                break
