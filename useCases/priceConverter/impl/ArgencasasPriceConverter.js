...
class ArgencasasPriceConverter {
    constructor() {}
    ...
    #convertFromUsd(price) {
        const firstStep = price.replace("u$s", "")
...
const argencasasPriceConverterInstance = new ArgencasasPriceConverter() 

module.exports = argencasasPriceConverterInstance