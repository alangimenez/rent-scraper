...
class RemaxPriceConverter {
    ...
    #convertFromArs(price) {
        ...
        const secondStep = firstStep.replaceAll(" ", "")
        const thirdStep = price.replace("ARS", "")
...
const remaxPriceConverterInstance = new RemaxPriceConverter() 

module.exports = remaxPriceConverterInstance